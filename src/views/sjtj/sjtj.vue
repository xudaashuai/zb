                ...
                series: [
                    {
                        ...
                        name: '商品销售占比',
                        data: [
                            ['和田玉', _this.categoryTurnover[0] / _this.monthTurnover * 100],
                            ['南红', _this.categoryTurnover[1] / _this.monthTurnover * 100],
                            ['碧玉', _this.categoryTurnover[2] / _this.monthTurnover * 100],
                            ['翡翠', _this.categoryTurnover[3] / _this.monthTurnover * 100],
                            ['绿松石', _this.categoryTurnover[4] / _this.monthTurnover * 100],
                            ['蜜蜡', _this.categoryTurnover[5] / _this.monthTurnover * 100],
